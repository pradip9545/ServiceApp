...
@IonicPage()
@Component({
  selector: 'page-traininghome',
  templateUrl: 'traininghome.html',
})
export class TraininghomePage {
  ...
  code1:any;
   loading:any;
   isAudio:boolean;
  constructor(public modalCtrl:ModalController,public smartAudio:SmartAudioProvider,public http:Http,public storage:Storage,public loadingCtrl:LoadingController,public navCtrl: NavController, public navParams: NavParams) {
 ...
 this.fetch_machine();
  ...
  selected(val){
  let response=val;
    let profileModal=this.modalCtrl.create("TrainingFormPage",{response}, { cssClass: 'inset-modal' })
